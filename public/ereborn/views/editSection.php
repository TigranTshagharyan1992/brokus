							...
							<div class="top-section-funktional">
								...
								<div>
									...
									<?php
										...
										{
											?>
												&nbsp;&nbsp;&nbsp;<div class="deleteButton-fake btn red" id="delete">Delete <img src="img/x-square1.png" alt=""></div>
												<button type="submit" hidden name="delete" class="deleteButton btn red">Delete <img src="img/x-square1.png" alt=""></button>
											<?php
										}
									?>
								</div>
