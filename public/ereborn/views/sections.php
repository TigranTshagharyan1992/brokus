					...
					?>
						<div class="position-relative top-pad">
							...
							<section id="welcome" class="tm-section">
								<form action="<?php echo $_SERVER["SCRIPT_NAME"]."?".http_build_query($validQueryParams) ?>" method="post" class="contact-form white-background-color form-pading" name="orderForm">
