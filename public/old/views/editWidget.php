					...
					<section id="welcome" class="tm-section tabs-wrapper">
						<form action="<?php echo SECTION_LINK ?>" method="post" class="contact-form  position-relative" enctype="multipart/form-data">
							...
							<div class="top-section-funktional">
								<a  href="<?php echo $_SERVER["SCRIPT_NAME"]."?widgets&pid=".$entity["entity_parent"]."&page=".$page ?>" class="south-east btn blue"><span>Back</span> <img src="img/back.png" alt=""></a>
								<div>
										...
										if($entity["entity_removable"]===1)
											{
												?>
													&nbsp;&nbsp;&nbsp;
													<button type="submit" name="delete" class="deleteButton btn red"><span>Delete</span> <img src="img/x-square1.png" alt=""></button>
												<?php
											}
										}
