					...
					<div class="position-relative top-pad">
						<div class="top-section-funktional">
								...
								if($pid!=="0")
								{
									...
									if($parentEntity!==false)
									{
										...
										<div class="south-east-wrap">
											<a class="south-east btn blue" href="<?php echo $_SERVER["SCRIPT_NAME"]."?sections&pid=".$parentEntity["entity_parent"]."&page=".$page ?>"><span>Back</span> <img src="img/back.png" alt=""></a>
										</div>
										<?php
									}
								}
							...
							<div class="search-and-add">
								...
								<a class="btn green" href="<?php echo $_SERVER["SCRIPT_NAME"]."?addWidget&pid=".$pid."&page=".$page ?>"><span>Add new section</span> <img src="img/plus-square.svg" alt=""></a>
							</div>
						</div>
						...
						<section id="welcome" class="tm-section">
							<form action="<?php echo SECTION_LINK ?>" method="post" class="contact-form white-background-color form-pading widget-form" name="orderForm">
											...
											foreach($results as $result)
											{
												...
												?>
													<tr id="<?php echo $entityId ?>">
                                                        ...
                                                        <td class="titleColumn fix-width">
															<?php

																echo  $result['ed_text_1'];
															?>
														</td>
														<?php
															foreach($additionalColumnsInWidgets as $key=>$value)
