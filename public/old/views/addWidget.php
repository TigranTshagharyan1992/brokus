						...
						<section id="welcome" class="tm-section tabs-wrapper">
							<form action="<?php echo SECTION_LINK ?>" method="post" class="contact-form" enctype="multipart/form-data">
								<div class="top-section-funktional">
									<a href="<?php echo $_SERVER["SCRIPT_NAME"]."?widgets&pid=".$pid."&page=".$page ?>" class="south-east btn blue"> <span>Back</span> <img src="img/back.png" alt=""></a>
									
									<button type="submit" name="add" class="tm-button btn green"><span>Add</span> <img src="img/plus-square.svg" alt=""> </button>
